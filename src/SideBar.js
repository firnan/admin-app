                ...
                <section className="sidebar">
                    <div className="user-panel">
                        <div className="pull-left image">
                            <img src="img/codemi-394x150.png" className="img-circle" alt="User Image" />
                        </div>
                    ...
                    <ul className="sidebar-menu" data-widget="tree">
                        ...
                        <a href="pages/widgets.html">
                            <i className="fa fa-th"></i> <span>Learning Plans</span>
                            <span className="pull-right-container">
                        ...
                        <a href="pages/calendar.html">
                            <i className="fa fa-calendar"></i> <span>Skills</span>
                            <span className="pull-right-container">
                        ...
                        <a href="pages/mailbox/mailbox.html">
                            <i className="fa fa-envelope"></i> <span>Report</span>
                            <span className="pull-right-container">
